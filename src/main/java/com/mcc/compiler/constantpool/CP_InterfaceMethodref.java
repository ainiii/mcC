...
public class CP_InterfaceMethodref implements ICPEntry {
    ...
    public CP_InterfaceMethodref(short classIndex, short nameAndTypeIndex) {
    ...
    @Override
    public byte getTag() { return ConstantPool.CONSTANT_InterfaceMethodref; }
}
