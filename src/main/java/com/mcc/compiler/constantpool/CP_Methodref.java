...
public class CP_Methodref implements ICPEntry {
    ...
    public CP_Methodref(short classIndex, short nameAndTypeIndex) {
    ...
    @Override
    public byte getTag() { return ConstantPool.CONSTANT_Methodref; }
}
